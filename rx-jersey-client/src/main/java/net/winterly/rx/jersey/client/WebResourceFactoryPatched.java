 ...
 */
public final class WebResourceFactoryPatched implements InvocationHandler {
    ...
    private WebResourceFactoryPatched(final WebTarget target, final MultivaluedMap<String, Object> headers,
    ...
    public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
        ...
        if (httpMethod == null) {
            ...
            return WebResourceFactoryPatched.newResource(responseType, newTarget, true, headers, cookies, form);
        }
